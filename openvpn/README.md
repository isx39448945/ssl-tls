...
```            
[munlai@192 server]$ openssl x509 -noout -text -in servercert.pem
...
```
[munlai@192 client1]$ openssl x509 -noout -text -in client1cert.pem
...
```
[munlai@192 client2]$ openssl x509 -noout -text -in client2cert.pem
